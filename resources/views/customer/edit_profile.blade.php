                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{route('profile.update')}}" method="POST" autocomplete="off">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">   
                                                                    <fieldset class="form-group">
                                                                        <label for="email">Customer Level</label> <a href="" style="font-size: smaller;">&nbsp;&nbsp;Upgrade</a>
                                                                        <input autocomplete="false" type="phone" class="form-control" disabled value="Level {{ auth()->user()->customer->customer_level }}">
                                                                    </fieldset>
                                                                </div>
                                                            </div>
                                                            <div class="row">
