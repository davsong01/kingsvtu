                                                                ...
                                                                @if(getSettings()->allow_fund_with_reserved_account == 'yes')
                                                                    <div class="tab-pane {{ getSettings()->allow_fund_with_card  !== 'yes' ? 'active' : ''}}" id="variations" role="tabpanel" aria-labelledby="profile-tab-fill">
                                                                        @if(auth()->user()->customer->reserved_accounts->count() > 0)
                                                                            ...
                                                                            <span style="color:blue"><small>Please note that it is strongly advised that users do not fund amounts higher than <strong>{{ getSettings()->currency }}20,000</strong> on squad since the higher the funding, the higher the charges. For bulk funding please send the payment to <strong>IKPOZA BUSINESS VENTURES, Moniepoint MFB: 8121614431</strong> then contact the support department for manual approval. This type of bulk funding attracts just <strong>{{ getSettings()->currency }}50</strong> general stamp charges.</small></span>
                                                                            </p>    
                                                                            <div>
