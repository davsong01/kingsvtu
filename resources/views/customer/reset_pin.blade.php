                                            ...
                                            <div class="card">
                                                <div class="col-md-12"> 
                                                    <div class="card-header" style="padding:1.4rem 0.7rem">
                                                        <h4 class="card-title">Reset Transaction Pin</h4>
                                                        <p>Please enter your current password and we will send a transaction reset link to your email address: <strong> {{ auth()->user()->email }}</strong></p>
                                                        @include('layouts.alerts')
                                                    </div>
                                                </div>
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form action="{{route('process.transaction.pin.reset')}}" method="POST" autocomplete="off">
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col-md-12">   
                                                                    ...
                                                                    <button class="btn btn-primary" type="submit">Send me reset link</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
