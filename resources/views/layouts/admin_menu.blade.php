 <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content" style="margin-top: 20px;" >
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            ...
            <li class="nav-item"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" fill="white" height="24" viewBox="0 -960 960 960" width="24"><path d="M660-570q-25 0-42.5-17.5T600-630q0-25 17.5-42.5T660-690q25 0 42.5 17.5T720-630q0 25-17.5 42.5T660-570Zm-360 0q-25 0-42.5-17.5T240-630q0-25 17.5-42.5T300-690q25 0 42.5 17.5T360-630q0 25-17.5 42.5T300-570Zm180 110q-25 0-42.5-17.5T420-520q0-25 17.5-42.5T480-580q25 0 42.5 17.5T540-520q0 25-17.5 42.5T480-460Zm0-220q-25 0-42.5-17.5T420-740q0-25 17.5-42.5T480-800q25 0 42.5 17.5T540-740q0 25-17.5 42.5T480-680Zm0 520q-20 0-40.5-3t-39.5-8v-143q0-35 23.5-60.5T480-400q33 0 56.5 25.5T560-314v143q-19 5-39.5 8t-40.5 3Zm-140-32q-20-8-38.5-18T266-232q-28-20-44.5-52T205-352q0-26-5.5-48.5T180-443q-10-13-37.5-39.5T92-532q-11-11-11-28t11-28q11-11 28-11t28 11l153 145q20 18 29.5 42.5T340-350v158Zm280 0v-158q0-26 10-51t29-42l153-145q12-11 28.5-11t27.5 11q11 11 11 28t-11 28q-23 23-50.5 49T780-443q-14 20-19.5 42.5T755-352q0 36-16.5 68.5T693-231q-16 11-34.5 21T620-192Z"/></svg><span class="menu-title" data-i18n="Form Elements">&nbsp;Customers</span></a>
                <ul class="menu-content">
            ...
            <li class="nav-item"><a href="#"><svg fill="white" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M80-200v-80h400v80H80Zm0-200v-80h200v80H80Zm0-200v-80h200v80H80Zm744 400L670-354q-24 17-52.5 25.5T560-320q-83 0-141.5-58.5T360-520q0-83 58.5-141.5T560-720q83 0 141.5 58.5T760-520q0 29-8.5 57.5T726-410l154 154-56 56ZM560-400q50 0 85-35t35-85q0-50-35-85t-85-35q-50 0-85 35t-35 85q0 50 35 85t85 35Z"/></svg><span class="menu-title" data-i18n="Form Elements">&nbsp;Financials</span></a>
                <ul class="menu-content">
                    <li class="{{ Route::is('transactions.*') ? 'active' : '' }}"><a href="{{ request()->route()->getPrefix() }}/admins"><i class="bx bx-right-arrow-alt"></i><span class="menu-item">Product Purchase</span></a>
                    </li>
                    <li class="{{ Route::is('transactions.*') ? 'active' : '' }}"><a href="{{ request()->route()->getPrefix() }}/admins"><i class="bx bx-right-arrow-alt"></i><span class="menu-item">Wallet Funding Log</span></a>
                    </li>
                    <li class="{{ Route::is('transactions.*') ? 'active' : '' }}"><a href="{{ request()->route()->getPrefix() }}/admins"><i class="bx bx-right-arrow-alt"></i><span class="menu-item">Wallet Log</span></a>
                    </li>
                    <li class="{{ Route::is('transactions.*') ? 'active' : '' }}"><a href="{{ request()->route()->getPrefix() }}/admins"><i class="bx bx-right-arrow-alt"></i><span class="menu-item">Earnings Log</span></a>
                    </li>
                    <li class="{{ Route::is('transactions.*') ? 'active' : '' }}"><a href="{{ request()->route()->getPrefix() }}/admins"><i class="bx bx-right-arrow-alt"></i><span class="menu-item">Credit Customer</span></a>
                    </li>
                    <li class="{{ Route::is('transactions.*') ? 'active' : '' }}"><a href="{{ request()->route()->getPrefix() }}/admins"><i class="bx bx-right-arrow-alt"></i><span class="menu-item">Debit Customer</span></a>
                    </li>
                    <li class="{{ Route::is('transactions.*') ? 'active' : '' }}"><a href="{{ request()->route()->getPrefix() }}/admins"><i class="bx bx-right-arrow-alt"></i><span class="menu-item">Verify Biller</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="{{ Request::path() == 'paymentgateway' ? 'active' : '' }}"><a href="{{ route('paymentgateway.index')}}"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m480-560-56-56 63-64H320v-80h167l-64-64 57-56 160 160-160 160ZM280-80q-33 0-56.5-23.5T200-160q0-33 23.5-56.5T280-240q33 0 56.5 23.5T360-160q0 33-23.5 56.5T280-80Zm400 0q-33 0-56.5-23.5T600-160q0-33 23.5-56.5T680-240q33 0 56.5 23.5T760-160q0 33-23.5 56.5T680-80ZM40-800v-80h131l170 360h280l156-280h91L692-482q-11 20-29.5 31T622-440H324l-44 80h480v80H280q-45 0-68.5-39t-1.5-79l54-98-144-304H40Z" fill="white"/></svg><span class="menu-title">&nbsp;Payment Gateway Settings</span></a></li>
            
            <li class="{{ Request::path() == 'settings' ? 'active' : '' }}"><a href="{{ route('settings.edit')}}"><svg fill="white" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m370-80-16-128q-13-5-24.5-12T307-235l-119 50L78-375l103-78q-1-7-1-13.5v-27q0-6.5 1-13.5L78-585l110-190 119 50q11-8 23-15t24-12l16-128h220l16 128q13 5 24.5 12t22.5 15l119-50 110 190-103 78q1 7 1 13.5v27q0 6.5-2 13.5l103 78-110 190-118-50q-11 8-23 15t-24 12L590-80H370Zm70-80h79l14-106q31-8 57.5-23.5T639-327l99 41 39-68-86-65q5-14 7-29.5t2-31.5q0-16-2-31.5t-7-29.5l86-65-39-68-99 42q-22-23-48.5-38.5T533-694l-13-106h-79l-14 106q-31 8-57.5 23.5T321-633l-99-41-39 68 86 64q-5 15-7 30t-2 32q0 16 2 31t7 30l-86 65 39 68 99-42q22 23 48.5 38.5T427-266l13 106Zm42-180q58 0 99-41t41-99q0-58-41-99t-99-41q-59 0-99.5 41T342-480q0 58 40.5 99t99.5 41Zm-2-140Z"/></svg><span class="menu-title">&nbsp;General Settings</span></a></li>
