     ...
     <div class="main-menu-content" style="margin-top: 20px;">
         <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
             ...
             <li class="nav-item"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" height="24"
                 ...
                 <ul class="menu-content">
                     <li class="{{ Route::is('api.*') ? 'active' : '' }}"><a href="{{ route('api.index') }}"><i
                                 class="bx bx-right-arrow-alt"></i><span class="menu-item">API Providers</span></a>
                     </li>
                     ...
                     <li class="{{ Route::is('product.*') ? 'active' : '' }}"><a href="{{ route('product.index') }}"><i
                                 class="bx bx-right-arrow-alt"></i><span class="menu-item"
                                 data-i18n="Input">Products</span></a>
                     </li>
                 </ul>
             </li>
             {{-- <li class="nav-item"><a href="#"><i class="bx bx-folder-open" data-icon="check"></i><span
                         class="menu-title" data-i18n="Form Elements">Announcement</span></a>
                 <ul class="menu-content">
                     <li class="{{ Route::is('announcement.index') ? 'active' : '' }}"><a
                             href="{{ route('announcement.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                                 class="menu-item">Pop-Up Announcement</span></a>
                     </li>
                     <li class="{{ Route::is('announcement.scroll') ? 'active' : '' }}"><a
                             href="{{ route('announcement.scroll') }}"><i class="bx bx-right-arrow-alt"></i><span
                                 class="menu-item" data-i18n="Input Groups">Scrolling Announcement</span></a>
                     </li>
                 </ul>
             </li> --}}
             <li class="nav-item"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" fill="white"
                 ...
                 <ul class="menu-content">
                     <li class="{{ Route::is('customers') ? 'active' : '' }}"><a href="{{ route('customers') }}"><i
                                 class="bx bx-right-arrow-alt"></i><span class="menu-item">All customers</span></a>
                     </li>
                     <li class="{{ Route::is('customers.active.*') ? 'active' : '' }}"><a
                             href="{{ route('customers.active', 'active') }}"><i
                                 class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Input">Active
                                 Customers</span></a>
                     </li>
                     ...
                     <li class="{{ Route::is('customerlevel.*') ? 'active' : '' }}"><a
                             href="{{ route('customerlevel.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                                 class="menu-item" data-i18n="Input Groups">Customer Levels</span></a>
                     </li>
                 </ul>
             </li>
                 ...
                 <ul class="menu-content">
                     <li class="{{ Route::is('admin.trans') ? 'active' : '' }}"><a
                             href="{{ route('admin.trans') }}"><i
                                 class="bx bx-right-arrow-alt"></i><span class="menu-item">Product Purchase Log</span></a>
                     </li>
                     <li class="{{ Route::is('admin.walletfundinglog') ? 'active' : '' }}"><a
                             href="{{ route('admin.walletfundinglog') }}"><i
                                 class="bx bx-right-arrow-alt"></i><span class="menu-item">Wallet Funding Log</span></a>
                     </li>
                     <li class="{{ Route::is('admin.walletlog') ? 'active' : '' }}"><a
                             href="{{ route('admin.walletlog') }}"><i
