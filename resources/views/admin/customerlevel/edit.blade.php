                                        ...
                                        <form action="{{route('customerlevel.update', $customerlevel->id)}}" method="POST">
                                            ...
                                            @method('PATCH')
                                             <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <label for="extra_benefit">Extra Benefits for this level (Will be shown on customer upgrade page)</label>
                                                        ...
                                                        <div class="editor" style="min-height: 250px">
                                                            {!! $customerlevel->extra_benefit ?? old('extra_benefit') !!}
                                                        </div>
