                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('levelbenefit.index') }}">Customer Levels</a>
                                    </li>
                                    <li class="breadcrumb-item active">Edit {{ $levelbenefit->title }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Edit {{ $levelbenefit->title }}</h4>
                                    {{-- <p>Add new category</p> --}}
                                    @include('layouts.alerts')
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{route('levelbenefit.update', $levelbenefit->id)}}" method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="title" value="{{ $levelbenefit->title ?? old('title')}}">
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <div class="editor" style="min-height: 250px">
                                                            {!! $levelbenefit->content ?? old('content') !!}
                                                        </div>
