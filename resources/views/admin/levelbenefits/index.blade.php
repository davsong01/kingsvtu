@extends('layouts.app')
@section('title', 'All Customer Levels Benefits')
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">All Customer Level Benefits
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">All Customer Level Benefits</h4> <br>
                                    <a href="{{ route('levelbenefit.create') }}"><button id="addRow"
                                            class="btn btn-primary mb-2 d-flex align-items-center"><i
                                                class="bx bx-plus"></i>&nbsp; Add Customer Level Benefit</button></a>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if(hasAccess('levelbenefit.edit'))
                                                                    <a href="{{ route('levelbenefit.edit', $level->id) }}"><button
                                                                    type="button" class="btn btn-primary btn-sm mr-1 mb-1"><span class="align-middle ml-25">View/Edit</span></button></a>
                                                                @endif
                                                                @if(hasAccess('levelbenefit.destroy'))
                                                                        <form
                                                                            action="{{ route('levelbenefit.destroy', $level->id) }}"
