...
@section('content')
    @php
        $selectedLevels = collect(old('customer_levels', []))->map(fn ($level) => (int) $level)->all();
    @endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="admin-page-hero mb-4">
                <div>
                    ...
                    <h1>Add customer level benefit</h1>
                    <p>Create the content shown on the level upgrade page with a modern editor and cleaner controls.</p>
                </div>
            </div>

            @include('sneat.layouts.alerts')

            <form action="{{ route('levelbenefit.store') }}" method="POST" id="benefit-form">
                @csrf
                <div class="row g-4">
                    <div class="col-xl-8">
                        <div class="modern-admin-card card h-100">
                            <div class="card-header">
                                ...
                                <p>Write the heading and benefit body.</p>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <label class="modern-admin-label" for="title">Title</label>
                                        <input type="text" class="form-control form-control-{{ formControlSize() }}" name="title" id="title" value="{{ old('title') }}" required>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="modern-quill-shell">
                                            ...
                                            <div id="benefit-editor" class="modern-quill-editor">{!! old('content') !!}</div>
                                        </div>
                    ...
                    <div class="col-xl-4">
                        <div class="modern-admin-card card h-100">
                            <div class="card-header">
                                <h3>Target levels</h3>
                                <p>Select which customer levels should see this benefit.</p>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="modern-admin-footer mt-4">
                            <button class="btn btn-admin-submit" type="submit">Save benefit</button>
                        </div>
                    </div>
                </div>
            </form>
