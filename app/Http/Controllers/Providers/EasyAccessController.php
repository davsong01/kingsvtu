    ...
    public function getVariations($product)
    {
        ...
        if (isset($variations['response_description']) && $variations['response_description'] == '000') {
            ...
            foreach ($variations as $variation) {
                // if(in_array($variation[
                    'variation_code'], $existingVariations)){
                // }else{
                ...
                [
                 ...
                 ', varition_amount' =>],
                    [
                     ...
                     [
                        'variation_code' => 147, 'fixedPrice' => 'Yes', 'name' => '70GB (CG) - N1576923600 30days', 'varition_amount' =>],
                     [
                        'variation_code' => 148, 'fixedPrice' => 'Yes', 'name' => '75GB (CG) - N1689561000 30days', 'varition_amount' =>],
                     [
                        'variation_code' => 149, 'fixedPrice' => 'Yes', 'name' => '80GB (CG) - N1802198400 30days', 'varition_amount' =>],
                     [
                        'variation_code' => 150, 'fixedPrice' => 'Yes', 'name' => '90GB (CG) - N2027473200 30days', 'varition_amount' =>],
                     [
                        'variation_code' => 151, 
                        'fixedPrice' => 'Yes', 
                    ...
                    [
                        'variation_code' => 152, 'fixedPrice' => 'Yes', 'name' => '750MB (Direct) - N47262500 14days'
                    ', varition_amount' =>],
                     [
                        'variation_code' => 83, 'fixedPrice' => 'Yes', 'name' => '1.5GB (Direct) - N965 .15 30days],
                     ],
